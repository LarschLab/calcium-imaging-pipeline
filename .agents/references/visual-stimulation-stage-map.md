...
3. Stimulus CSV loading and trial sequence construction
    ...
    - Outputs: in-memory stimulus tables, exact trial order, planned schedule rows, planned block rows with acquisition-window duration and acquisition frame counts
