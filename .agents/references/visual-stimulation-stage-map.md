...
1. Operator setup
   ...
   - Outputs: in-memory metadata (via scrollable parameter forms), selected stimulus directory, monitor config, mock-run flags, planned trial order, auto-refresh preview timeline with stimulus-type coloring
